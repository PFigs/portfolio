function data = parserinexobservation(file,idx,fSize,data, obs, nObs)
    ...
    for k=idx+1:fSize
        ...
        if strcmpi(state,'epochstart')
            ...
            [gpssats,nGPS] = getsatellites(file{k},gpspos);
            [glosats,nGLO] = getsatellites(file{k},glopos);
        ...
        elseif strcmpi(state,'epochcont')
            ...
            [gpssats,nGPS] = getsatellites(file{k},gpspos,gpssats);
            [glosats,nGLO] = getsatellites(file{k},glopos,glosats);
