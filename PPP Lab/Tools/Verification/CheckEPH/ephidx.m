...
% Pedro Silva, Instituto Superior Tecnico, January 2012
    ...
    elseif strcmpi('SQRA',str)
        idx = 19;
    elseif strcmpi('DN',str) || strcmpi('deltan',str)
        idx = 20;
    elseif strcmpi('Omega0',str)
        idx = 21;
    elseif strcmpi('I0',str)
        idx = 22;
    elseif strcmpi('Omega',str) || strcmpi('argper',str)% argument perigee
        idx = 23;
    ...
    elseif strcmpi('UPDATE',str)
        ...
        disp(['ephidx: Ooops did not find match for ' str]);
        idx = NaN;
    end
